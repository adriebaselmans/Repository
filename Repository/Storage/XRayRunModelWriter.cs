...
namespace Repository.Storage
{
    ...
    {
        private const string MetaFileName = "xrayrun.meta";
        private const string BulkFileName = "xrayrun.bulk";
        ...
        public void Write(XrayRunModel xrayRunModel)
        {
            ...
            using (var fileStream = File.Create(BulkFileName))
            {
            ...
            using (var fileStream = File.Create(MetaFileName))
            {
